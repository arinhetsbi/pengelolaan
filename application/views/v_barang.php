            ...
            <form class="form-horizontal">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <input name="kobar_edit" id="kode_barang2" class="form-control" type="text" placeholder="ID menambah otomatis" style="width:335px;" readonly>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        function tampil_data_barang(){
            $.ajax({
                type  : 'GET',
                url   : '<?php echo base_url()?>admin/barang/data_barang',
                async : true,
                dataType : 'json',
        ...
        $('#btn_simpan').on('click',function(){
            console.log($('#nama_barang').val() + $('#harga').val());
            // $.ajax({
            //     type : "POST",
            //     url  : "<?php echo base_url('admin/barang/simpan_barang')?>",
            //     dataType : "JSON",
            //     data : {nabar:nabar, harga:harga},
            //     success: function(data){
            //         // $('[name="kobar"]').val("");
            //         $('[name="nabar"]').val("");
            //         $('[name="harga"]').val("");
        ...
        $('#btn_update').on('click',function(){
            ...
            $.ajax({
                type : "POST",
                url  : "<?php echo base_url('admin/barang/update_barang')?>",
                dataType : "JSON",
